...
export default function CollectionItem({ product }: CollectionItemProp): JSX.Element {
  ...
  return (
    <div className="w-full md:w-[24%] md:grow shrink-0 cursor-pointer" onClick={handleRedirection}>
      ...
      <div className="px-3 md:px-4 py-2.5 md:py-3.5">
        ...
        <h3 className="text-base md:text-[24px] font-[baskerVille] line-clamp-1 tracking-tight uppercase leading-[120%] md:leading-[19.5px] text-[#000000]">
          {product.productName}
        </h3>
      </div>
