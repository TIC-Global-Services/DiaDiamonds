...
export default function Arrivals() {
  ...
  return (
    <div ref={containerRef}  className="relative w-full h-screen flex flex-wrap md:flex-nowrap overflow-hidden">
      ...
      <div className="relative w-full h-full hover:scale-110 delay-100 duration-300 ease-in-out overflow-hidden">
        <Parallax speed={-10}>
      ...
      <div className="w-full h-full relative hover:scale-110 delay-100 duration-300 ease-in-out overflow-hidden">
        <Parallax speed={-10}>
