      ...
      <div className="w-full absolute inset-0">
        <ContainerLayout>
          ...
          className="flex items-start pt-[10%] md:pt-0">
            <h2 className="text-2xl md:text-[40px] font-medium leading-[120%] md:leading-[100%] tracking-[3%] md:tracking-[5%] uppercase text-[#000000] pb-3 md:pb-8">
            Why Dia Diam
          </h2>
          <img src={diamond} alt="diamond logo" className="w-6 md:w-10 aspect-square" />
          <h2 className="text-2xl md:text-[40px] font-medium leading-[120%] md:leading-[100%] tracking-[3%] md:tracking-[5%] uppercase text-[#000000] pb-3 md:pb-8">
            nds?
          </h2>
          </motion.div>
          ...
          transition={{duration:0.5, delay:0.2, ease:'easeInOut'}}
          viewport={{once:false}}
          className="text-sm md:text-[20px] leading-[140%] md:leading-[140%] text-[#000000]/50 w-[90%] md:w-[40%]">
