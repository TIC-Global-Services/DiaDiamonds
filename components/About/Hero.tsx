...
export default function Hero() {
  ...
  return (
    <ContainerLayout>
      ...
      <Parallax speed={-20}>
      <section className="w-full flex flex-wrap md:flex-nowrap justify-center items-center md:items-start md:h-[100dsvh] pt-[35%] md:pt-0 md:mt-10 pb-[24%] md:pb-0 md:-translate-y-[10%]">
        
        {/* Text content */}
        <div className="flex flex-col justify-center items-start mx-auto w-full md:w-2/5 gap-6 order-2 md:order-1 pt-[20%]">
          ...
          <motion.p
            ...
            viewport={{once:false}}
            className="text-[14px] md:text-[20px] leading-[140%] md:leading-[140%] text-[#000000] text-left md:text-left md:px-0"
          >
