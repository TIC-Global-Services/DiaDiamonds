...
export default function Hero() {
  ...
  return (
    <ContainerLayout>
      ...
      <Parallax speed={-20}>
      <section data-theme='light' className="w-full flex flex-wrap md:flex-nowrap justify-center items-center md:items-start md:h-[100vh] pt-[35%] md:pt-0 md:mt-10 pb-[24%] md:pb-0 md:-translate-y-[10%]">
        ...
        <motion.div
          ...
          viewport={{once:false}}
          className="w-full md:w-3/5 h-full flex items-start md:items-end relative md:gap-4 order-1 md:order-2"
        >
