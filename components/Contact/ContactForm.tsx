...
export default function ContactForm() {
    return (
        <section className="relative max-w-[1200px] mx-auto px-[3.64%] py-[8.25%] md:px-0 md:py-23 md:mt-20 w-full md:aspect-[1440/940] bg-[#F5ECE0]" data-theme="light">

            <div className="w-full md:absolute md:top-[-46.82%] md:left-[25.35%] md:w-[50.31%] rounded-[25px] md:rounded-[0px]  md:mx-auto bg-[#FCF9F4] p-[1.88%]">


                <h2 className="text-center py-8 md:py-0 md:pt-[7.32%] md:pb-[5.49%] h2 tracking-tight">Inquiry Form</h2>
                <form className="px-[6.32%] md:px-[3.38%] md:py-[1.69%]">

                    <label htmlFor="" className="pb-[2.63%] md:pb-[1.70%]">Full Name</label>
                    <input required type="text" maxLength={25} className="w-full aspect-332/40 md:aspect-542/54 mb-[8.96%] p-4 md:mb-[3.39%] bg-[#FFFFFF]/40 backdrop-blur-md border border-white rounded-3xl shadow-[inset_0px_0px_4px_0_rgba(0,0,0,0.25)]" />
                    ...
                    <textarea className="w-full aspect-332/180 md:aspect-542/180 mb-[8.96%] md:mb-[3.39%] p-4 bg-[#FFFFFF]/40 backdrop-blur-md border border-white/30 rounded-3xl shadow-[inset_0px_0px_4px_0_rgba(0,0,0,0.25)]" />

                    <label htmlFor="">Attach File</label>
                    <div className="relative flex flex-col justify-center items-center border-dashed border-[1px] rounded-[10px] py-[2.53%] px-[3.68%] ">
