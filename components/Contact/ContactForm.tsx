        ...
        <section className="relative px-[3.64%] py-[8.25%] md:px-0 md:py-0  w-full md:aspect-1440/753 bg-[#F5ECE0]" data-theme="light">
            ...
            <div className="w-full md:absolute md:top-[-44.82%] md:left-[25.35%] md:w-[49.31%] rounded-[25px] md:rounded-[0px]  md:mx-auto bg-[#FCF9F4] p-[1.88%]">
                ...
                <form className="px-[6.32%] md:px-[3.38%] md:py-[1.69%]">
                    ...
                    <input required type="text" placeholder="Enter Full Name" className="w-full placeholder:text-gray-300 aspect-332/40 md:aspect-542/54 mb-[8.96%] p-4 md:mb-[3.39%] bg-[#FFFFFF]/40 backdrop-blur-md border border-white/30 rounded-3xl shadow-[inset_-1px_-1px_4px_0_rgba(0,0,0,0.25)]" />

                    <label htmlFor="" className="pb-[2.63%] md:pb-[1.70%]">Email</label>
                    <input required type="text" placeholder="Enter Email" className="w-full placeholder:text-gray-300 aspect-332/40 md:aspect-542/54 mb-[8.96%] p-4 md:mb-[3.39%] bg-[#FFFFFF]/40 backdrop-blur-md border border-white/30 rounded-3xl shadow-[inset_-1px_-1px_4px_0_rgba(0,0,0,0.25)] " />

                    <label htmlFor="" className="pb-[2.63%] md:pb-[1.70%]">Subject</label>
                    <input required type="text" placeholder="Enter Subject" className="w-full placeholder:text-gray-300 aspect-332/40 md:aspect-542/54 mb-[8.96%] p-4 md:mb-[3.39%] bg-[#FFFFFF]/40 backdrop-blur-md border border-white/30 rounded-3xl shadow-[inset_-1px_-1px_4px_0_rgba(0,0,0,0.25)]" />

                    <label htmlFor="" className="pb-[2.63%] md:pb-[1.70%]">Message</label>
                    <textarea placeholder="Enter Text" className="w-full placeholder:text-gray-300 aspect-332/180 md:aspect-542/180 mb-[8.96%] md:mb-[3.39%] p-4 bg-[#FFFFFF]/40 backdrop-blur-md border border-white/30 rounded-3xl shadow-[inset_-1px_-1px_4px_0_rgba(0,0,0,0.25)]" />
                    ...
                    <div className="md:hidden ">
                        ...
                        <div className="relative flex flex-col justify-center items-center border-dashed border-[1px] rounded-[10px] py-[5.53%] px-[3.68%] ">
                            ...
                            <p className="text-center mb-[5.38%] text-[#B1B1B1] text-[13px] md:text-sm">Attach up to 10 files. The maximum allowed size per file is 10 MB.</p>
