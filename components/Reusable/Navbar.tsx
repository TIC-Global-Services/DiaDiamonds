      ...
      <div className={`w-full lg:w-[595px] h-[100svh] bg-[#ffffff] absolute right-0 top-0 ${navMenuClick ? 'block' : 'hidden'}`}>
        ...
        <ul className="w-full pt-[63px] pl-10 pr-10">
          <li className={`w-full flex justify-between items-center text-[32px] leading-[110%] text-[#000000] uppercase ${collectionClick ? '' : 'pb-10'}`}>
            <p className={`${collectionClick ? 'underline' : ''} hover:cursor-pointer hover:scale-110 active:scale-100`} onClick={()=>setCollectionClick(!collectionClick)}>Collection</p>
            <div onClick={()=>setCollectionClick(false)} className={`${collectionClick ? 'block' : 'hidden'} w-4 border-t-2 border-[#000000] hover:cursor-pointer hover:scale-110 active:scale-100`}></div>
          </li>
          <ul className={`pt-[30px] pb-10 ${collectionClick ? 'block' : 'hidden'}`}>
              <li className="pb-[14px] text-2xl leading-[100%] ">
                <p className="hover:cursor-pointer hover:scale-110 active:scale-100">Rings</p>
              </li>
              <li className="pb-[14px] text-2xl leading-[100%]">
                <p className="hover:cursor-pointer hover:scale-110 active:scale-100">Pendants</p>
              </li>
              <li className="pb-[14px] text-2xl leading-[100%]">
                <p className="hover:cursor-pointer hover:scale-110 active:scale-100">Necklaces</p>
              </li>
              <li className="pb-[14px] text-2xl leading-[100%]">
                <p className="hover:cursor-pointer hover:scale-110 active:scale-100">Bracelets</p>
              </li>
              <li className="pb-[14px] text-2xl leading-[100%]">
                <p className="hover:cursor-pointer hover:scale-110 active:scale-100">Earrings</p>
              </li>
            </ul>
          <li className="text-[32px] leading-[110%] pb-10 text-[#000000] uppercase hover:cursor-pointer hover:scale-110 active:scale-100">
            About Us
          </li>
          <li className="text-[32px] leading-[110%] pb-10 text-[#000000] uppercase hover:cursor-pointer hover:scale-110 active:scale-100">
            Precision
